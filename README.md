...
이 개인적 경험에서 출발하여 "지연 공지 이후 추가 지연이 실제로 얼마나 발생하는가"를 데이터로 검증하고자 수집을 시작했고, 분석 결과 **지연 공지 후 89.9%의 항공편이 추가로 악화**된다는 사실을 확인했습니다.
...
> 2026년 2월 28일 수집 시작, 3월 23일 기준 인천공항 출발 여객편 **11,472건** 유효 수집

**추가 지연 분석** — 지연 공지 이력이 있고 관측 기간 10분 이상인 **2,020건** 기준:

| 구분          | 지표                                   | 수치       |
| :------------ | :------------------------------------- | :--------- |
| **변화 방향** | 지연 후 **추가 악화**                  | **89.9%**  |
|               | 변동 없음                              | 8.6%       |
|               | 오히려 **개선/단축**                   | 1.5%       |
...
| 발견                        | 운영 활용 가능성                                                                   |
| --------------------------- | ---------------------------------------------------------------------------------- |
| 지연 악화율 89.9%           | 최초 지연 공지 시 **추가 지연 가능성을 함께 안내**하여 승객 CS 비용 절감           |
