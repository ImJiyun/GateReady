...
이 개인적 경험에서 출발하여 "지연 공지 이후 추가 지연이 실제로 얼마나 발생하는가"를 데이터로 검증하고자 수집을 시작했고, 분석 결과 **지연 공지 후 81.0%의 항공편이 추가로 악화**된다는 사실을 확인했습니다.
...
> 2026년 2월 28일 수집 시작, 5월 12일 기준 인천공항 출발 여객편 **35,000건 이상** 유효 수집

**추가 지연 분석** — 지연 공지 이력이 있고 관측 기간 10분 이상인 **2,020건** 기준:

| 구분          | 지표                                   | 수치       |
| :------------ | :------------------------------------- | :--------- |
| **변화 방향** | 지연 후 **추가 악화**                  | **81.0%**  |
|               | 변동 없음                              | 8.6%       |
|               | 오히려 **개선/단축**                   | 1.5%       |
| **악화 상세** | 전체 중 **15분 이상** 크게 악화된 비중 | **40.3%**  |
|               | 악화 시 **평균 추가 지연 시간**        | **21.9분** |

**핵심 발견**: 지연 공지를 받은 항공편 **10건 중 8건은 결국 더 지연**되며, 악화된 경우 평균 약 22분이 추가됩니다.

**지연 사유별 악화 패턴** — 원인 미확인 편 제외:

| 지연 사유   | 평균 추가 지연 | 해석                                                     |
| :---------- | -------------: | :------------------------------------------------------- |
| 항공기 정비 |     **29.8분** | 정비 완료 시점 예측이 어려워 악화폭이 가장 큼            |
| 기상        |     **19.2분** | 기상 회복까지 대기 시간이 불확실하여 크게 악화           |
| 연결편 지연 |     **16.4분** | 선행 항공편의 지연이 연쇄적으로 전파                     |
| 공항·관제   |     **10.2분** | 관제·게이트 등 공항 인프라 사유는 상대적으로 빠르게 해소 |
| 승객·수화물 |      **8.9분** | 탑승·수화물 처리 사유는 소폭 악화에 그침                 |
| 승무원      |      **8.8분** | 승무원 교체·규정 관련 사유는 악화폭이 가장 작음          |

**시사점**: 동일한 "30분 지연 공지"라도 사유가 **항공기 정비**인 경우와 **승객·수화물**인 경우 추가 악화 예상치가 **약 3배 이상 차이**가 나므로, 사유별 차별화된 안내가 필요합니다.

### 태블로 시각화 대시보드

[태블로 시각화 대시보드](https://public.tableau.com/app/profile/jiyun.kim2059/viz/GateReady/Overview)

### 운영 시사점

| 발견                        | 운영 활용 가능성                                                                   |
| --------------------------- | ---------------------------------------------------------------------------------- |
| 지연 악화율 81.0%           | 최초 지연 공지 시 **추가 지연 가능성을 함께 안내**하여 승객 CS 비용 절감           |
| 15분 이상 악화 40.3%        | 15분 이상 악화가 예상되는 항공편에 대해 **게이트 재배정·지상 조업 일정 선제 조정** |
| 사유별 악화폭 최대 3배 차이 | 정비·기상 사유는 **장기 지연 대비 프로토콜**, 승객 사유는 **단기 대응**으로 차별화 |
...
- **표본 확대 및 검증**: 현재 약 24일 간 2,020건의 지연 항공편 기준 분석으로 계절성·요일별 패턴 검증을 위해 장기 수집 지속
