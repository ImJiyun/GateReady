...
> 2026년 2월 28일 수집 시작, 3월 12일 기준 인천공항 출발 여객편 **5,850건** 유효 수집

**추가 지연 분석** — 지연 공지 이력이 있고 관측 기간 10분 이상인 174건 기준:

| 구분          | 지표                                   | 수치       |
| :------------ | :------------------------------------- | :--------- |
| **변화 방향** | 지연 후 **추가 악화**                  | **73.0%**  |
|               | 변동 없음                              | 13.2%      |
|               | 오히려 **개선/단축**                   | 13.8%      |
| **악화 상세** | 전체 중 **15분 이상** 크게 악화된 비중 | **45.4%**  |
|               | 악화 시 **평균 추가 지연 시간**        | **21.2분** |

**핵심 발견**: 지연 공지를 받은 항공편 **4건 중 3건은 결국 더 지연**되며, 악화된 경우 평균 약 21분이 추가됩니다.

### 운영 시사점

| 발견                    | 운영 활용 가능성                                                                   |
| ----------------------- | ---------------------------------------------------------------------------------- |
| 지연 악화율 73.0%       | 최초 지연 공지 시 **추가 지연 가능성을 함께 안내**하여 승객 CS 비용 절감           |
| 15분 이상 악화 45.4%    | 15분 이상 악화가 예상되는 항공편에 대해 **게이트 재배정·지상 조업 일정 선제 조정** |
